...
public:
    ...
    void draw_triangle(const Triangle& triangle,sf::RenderTarget& target, bool isMeshActive, const Camera& cam ) const; // drawing single triangle 
    void draw_border(sf::RenderTarget& target, const Triangle& triangle) const;                                         // drawing a triangle border
    void fill_triangle(sf::RenderTarget& target, sf::Color color, const Triangle& triangle) const;                      // filling triangle with color 
